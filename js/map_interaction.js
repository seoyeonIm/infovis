import { createFilteredGraph } from "https://raw.githubusercontent.com/seoyeonIm/infovis/main/js/filtered_graph.js"; // filtered_graph.js 가져오기
import { createFilteredGraphBottom } from "https://raw.githubusercontent.com/seoyeonIm/infovis/main/js/filtered_graph_bottom.js"; // filtered_graph_bottom.js 가져오기
      ...
      onEachFeature: function (feature, layer) {
        layer.on({
          click: function () {
            ...
            fetch("https://raw.githubusercontent.com/seoyeonIm/infovis/main/js/place.json") // 그래프 데이터를 새로 불러옴
              .then((response) => response.json())
              .then((graphData) => {
                createFilteredGraph(
                  graphData,
